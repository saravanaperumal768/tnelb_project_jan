            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="seperator-header layout-top-spacing">
                        <h4 class="">Completed Applications For B (License EB )</h4>
                            ...
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($application->dt_submit)->format('d-m-Y h:i:s A') }}</td>
                                        
                                        <td>
                                            {{ 
                                                $licenses[$application->application_id]->license_number
                                                ?? $renewalLicenses[$application->application_id]->license_number
                                                ?? '-' 
                                            }}
                                        </td>
