                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                        <div class="row mt-3 ">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    @if(isset($uploadedPhoto) && !empty($uploadedPhoto->upload_photo))
                                                    <img src="http://10.163.2.190:8002/storage/{{ $uploadedPhoto->upload_photo }}"
                                                        alt="Applicant Photo"
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center;">
                                                                ...
                                                                @php
                                                                // Get file extension
                                                                $fileExtension = pathinfo($document->education_doc ?? 'unknown.pdf', PATHINFO_EXTENSION);
                                                                @endphp
                                                                ...
                                                                <a href="http://10.163.2.190:8002/storage/{{ $document->education_doc }}" target="_blank">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center;">
                                                                ...
                                                                @php
                                                                $fileExtension = strtolower(pathinfo($document->experience_doc, PATHINFO_EXTENSION));
                                                                $fileUrl = url('http://10.163.2.190:8002/storage/' . $document->experience_doc);
                                                                @endphp

                                                                @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif']))
                                                                <!-- Show Image -->
                                                                <img src="{{ $fileUrl }}" alt="Experience Document" width="100">
                                                                @elseif($fileExtension === 'pdf')
                ...
                <div id="tabsSimple" class="col-xl-6 col-6 layout-spacing">
                    <div class="statbox widget box box-shadow mb-2">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                @php
                                    // var_dump(isset($queries));die;
                                @endphp
                                @if (isset($queries) && $queries->query_status == 'P')
