        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="row layout-top-spacing">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-five {{ $formColors[$form->licence_name] ?? 'bg-default' }} color_forms">
                                ...
                                <div class="account-box">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div style="text-align: end;">
                                             <a href="{{ route('admin.view_formsa_completed') }}"> <h4>Completed <span class="badge badge-success">{{ $auditorForma_pendings->completed_count }}</span> </h4> </a>
                                                 <a href="{{ route('admin.view_formsa_pending')  }}" class=""> <h4> Pending <span class="badge badge-warning">{{ $auditorForma_pendings->pending_count }}</span></h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="account-box">
                                    <div class="info-box">
                                     ...
                                     <div class="card-bottom-section">
                                        ...
                                        <div style="text-align: end;">
                                             <a href="{{ route('admin.view_formsb_completed') }}"> <h4>Completed <span class="badge badge-success">{{ $auditorForma_pendings->completed_count }}</span> </h4> </a>
                                                 <a href="{{ route('admin.view_formsb_pending')  }}" class=""> <h4> Pending <span class="badge badge-warning">{{ $auditorForma_pendings->pending_count }}</span></h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="account-box">
                                    <div class="info-box">
                                     ...
                                     <div class="card-bottom-section">
                                        ...
                                        <div style="text-align: end;">
                                             <a href="{{ route('admin.view_formb_completed') }}"> <h4>Completed <span class="badge badge-success">{{ $auditorForma_pendings->completed_count }}</span> </h4> </a>
                                                 <a href="{{ route('admin.view_formb_pending')  }}" class=""> <h4> Pending <span class="badge badge-warning">{{ $auditorForma_pendings->pending_count }}</span></h4></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
