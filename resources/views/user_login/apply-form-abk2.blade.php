                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-12">
                                    <textarea id="business_address" rows="2" class="form-control" name="business_address"></textarea>
                                ...
                                <table class="table table-bordered" id="staff-table">
                                    ...
                                    <tbody id="staff-container">
                                        ...
                                        @for ($i = 0; $i < $staff_count; $i++)
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="cc_number[]" placeholder="Certificate No" value="{{ old('cc_number.' . $i) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <input type="number" class="form-control" max="9999" id="bank_amount" name="bank_amount" value="">
