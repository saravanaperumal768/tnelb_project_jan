    ...
    <div class="container">
        ...
        <form id="competency_form_a" enctype="multipart/form-data">
            ...
            <div class="tabs" id="tabbedForm">
                ...
                @else
                <div class=" border box-shadow-blue p-3 mt-3" id="partner-section" style="display:none;">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Partners Details fresh 1</h5>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class=" mt-4 ">
                        <!-- <h3>Proprietor/Partner Details</h3> -->
                        <div class="col-12 col-md-12 text-md-right" id="static-add-button-wrapper">
                            <button id="add-more-proprietor-partner" class="btn btn-primary text-md-right"><i class="fa fa-plus"></i> Add More Partners</button>
                        </div>
                        <div id="proprietor-container"></div>
                    </div>
                </div>

                <!-- --------------Director fresh details------------------- -->
                <div class=" border box-shadow-blue p-3 mt-3" id="director-section" style="display:none;">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Directors Details fresh 1</h5>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class=" mt-4 ">
                        <!-- <h3>Proprietor/Partner Details</h3> -->
                        <div class="col-12 col-md-12 text-md-right" id="static-add-button-wrapper">
                            <button id="add-more-proprietor-director" class="btn btn-primary text-md-right"><i class="fa fa-plus"></i> Add More Directors</button>
                        </div>
                        <div id="proprietor-container"></div>
                    </div>
                ...
                <!-- ---------------------Proprietor Details fresh--------------- -->

                <div class=" border box-shadow-blue p-3 mt-3" id="proprietor-section" style="display:none;">
                    <div class="row">
                        <div class="col-md-6">
...
let proprietorCount = initialDraftCount || 0;
    ...
    <script>
        ...
        let currentMode = "proprietor";

        function getProprietorFields(index, mode = "proprietor") {
            let heading = "Proprietor/Partner Details " + (index + 1);

            if (mode === "partner") heading = "Partner Details " + (index + 1);
            if (mode === "director") heading = "Director Details " + (index + 1);
    ...
    `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.body.addEventListener("click", function(event) {
                ...
                if (event.target.id === "add-more-proprietor-partner") {
                    event.preventDefault();
                    if (partnerCount >= MAX_PARTNERS) {
                        return Swal.fire("Error", "You can only add up to " + MAX_PARTNERS + " partners.", "error");
                    }
                    const container = document.getElementById("proprietor-container");
                    container.insertAdjacentHTML("beforeend", getProprietorFields(partnerCount, "partner"));
                    partnerCount++;
                }

                // ADD DIRECTOR
                if (event.target.id === "add-more-proprietor-director") {
                    event.preventDefault();
                    if (directorCount >= MAX_DIRECTORS) {
                        return Swal.fire("Error", "You can only add up to " + MAX_DIRECTORS + " directors.", "error");
                    }
                    const container = document.getElementById("proprietor-container");
                    container.insertAdjacentHTML("beforeend", getProprietorFields(directorCount, "director"));
                    directorCount++;
                }
    ...
    <script>
        ...
        $('#type_of_ea_license').on('change', function() {
            ...
            // Hide all first
            $('#proprietor-section, #partner-section, #director-section').hide();

            if (selected == "1") {
                $('#proprietor-section').show();
            } else if (selected == "2") {
