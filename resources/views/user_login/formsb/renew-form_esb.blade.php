       ...
       <div class="apply-card-header bg-form">
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h5 class="card-title_apply text-white text-center text-uppercase"> <span style="font-weight: 600;">Renewal Application for Electrical Contractor's Licence-Grade `SB' </span></h5>
                                        ...
                                        <div class="col-12 col-md-12  experience-fields-proprietor" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-5 mt-1">
                                                    ...
                                                    <input class="form-control ea_license_number" type="text" id="previous_experience_lnumber" maxlength="15" name="previous_experience_lnumber[]" placeholder="Previous ESB Licence SB Grade License Number">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered head_label_partner">
                                 ...
                                 <p class=" text-danger">Note : Incase change of partner new application has to be Submitted</p>
                            </div>
                            <!-- <div class="col-12 col-md-5  text-md-right">
                                <h5>Number of Partners? (Min 2, Max 6)</h5>
                            </div>
