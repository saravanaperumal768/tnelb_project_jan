        ...
        <div class="apply-card-header" style="background-color: #70c6ef  !important;">
            <div class="row">
                <div class="col-12 col-lg-8">
                    <h5 class="card-title_apply text-black text-left"> <span style="font-weight: 600;">Renewal Application for Electrical Contractor's Licence-Grade `SA' </span></h5>
         ...
         <form id="contractor_form_sa" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                       ...
                                       @if($p->ownership_type === 'pr')
                                        <tr data-id="{{ $p->id }}">
                                           ...
                                           <!-- <td>
                                                <button type="button" class="btn btn-primary btn-sm update-proprietor-row-new" data-id="{{ $p->id }}">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-12  experience-fields-partner" style="display: none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-5 mt-1">
                                                        <label>Previous EA Licence A Grade Number <span class="text-red">*</span></label>
                                                        <input class="form-control ea_license_number" type="text" id="previous_experience_lnumber" maxlength="15" name="previous_experience_lnumber[]" placeholder="License Number">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input
                                            ...
                                            type="radio"
                                            name="tested_documents"
                                            id="tested_documents_yes"
                                            value="yes"
                                            {{ isset($equipmentlist->tested_documents) && $equipmentlist->tested_documents === 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input
                                            ...
                                            value="no"
                                            {{ !isset($equipmentlist->tested_documents) || $equipmentlist->tested_documents === 'no' ? 'checked' : '' }}>
                                ...
                                <!-- Tested Report Row -->
                                <div class="col-12 col-md-12 mt-2" id="tested_report_row" style="display: none;">
                                    <div class="row">
                                        <div class="col-12 col-md-3 text-md-right">
                                            <label for="tested_report_id">Tested Report ID <span class="text-danger">*</span></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-2">
                                            <input
                                                ...
                                                class="form-control"
                                                id="tested_report_id"
                                                name="tested_report_id"
                                                placeholder="Tested Report ID"
                                                value="{{ $equipmentlist->tested_report_id ?? '' }}">
                                            <span class="error text-danger" id="tested_report_id_error"></span>
                                        </div>

                                        <div class="col-12 col-md-1">
                                            <label for="validity_date_eq1">Validity Date <span class="text-danger">*</span></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-2">
                                            <input
                                                type="date"
                                                class="form-control"
                                                id="validity_date_eq1"
                                                name="validity_date_eq1"
                                                value="{{ isset($equipmentlist->validity_date_eq1) ? \Carbon\Carbon::parse($equipmentlist->validity_date_eq1)->format('Y-m-d') : '' }}">
                                            <span class="error text-danger" id="validity_date_eq1_error"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            type="radio"
                                            name="original_invoice_instr"
                                            id="original_invoice_instr_yes"
                                            value="yes"
                                            {{ isset($equipmentlist->original_invoice_instr) && $equipmentlist->original_invoice_instr === 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            type="radio"
                                            name="original_invoice_instr"
                                            id="original_invoice_instr_no"
                                            value="no"
                                            {{ !isset($equipmentlist->original_invoice_instr) || $equipmentlist->original_invoice_instr === 'no' ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-12"
                                    id="invoice_row"
                                    style="{{ isset($equipmentlist->original_invoice_instr) && $equipmentlist->original_invoice_instr === 'yes' ? '' : 'display:none;' }}">
                                    <div class="row mt-2">
                                        <div class="col-12 col-md-3 text-md-right">
                                        ...
                                        <div class="col-12 col-md-2">
                                            <input type="text"
                                                ...
                                                value="{{ $equipmentlist->invoice_report_id ?? '' }}">
                                            <span class="error text-danger" id="invoice_report_id_error"></span>
                                        </div>

                                        <div class="col-12 col-md-1">
                                            <label for="validity_date_eq2">Validity Date <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-12 col-md-2">
                                            <input type="date"
                                                class="form-control"
                                                id="validity_date_eq2"
                                                name="validity_date_eq2"
                                                value="{{ isset($equipmentlist->validity_date_eq2) ? \Carbon\Carbon::parse($equipmentlist->validity_date_eq2)->format('Y-m-d') : '' }}">
                                            <span class="error text-danger" id="validity_date_eq2_error"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-7">
                                    <label for="instrument3">
                                        16. The test report of the newly tested instrument 3
                                        <span class="text-danger">*</span>
                                    </label>
                                </div>
                                ...
                                <div class="col-12 col-md-12"
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12 col-md-3 text-md-right">
                                            <label for="instrument3_id">Instrument 3 ID <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-12 col-md-2">
                                            <input type="text"
                                                class="form-control"
                                                ...
                                                value="{{ $equipmentlist->instrument3_id ?? '' }}">
    ...
    `;
        ...
        $("#add-proprietor").on("click", function() {
            ...
            if (rowCount > 0) {
                ...
                // alert("Only one proprietor entry is allowed!");
                return;
            }
        ...
        // ----------------proprietor new application----------------

        $(document).on('click', '.update-proprietor-row-new', function() {
            // alert('111');
            Swal.fire({
                title: "Notice",
                width:600,
                text: "If you want to change proprietor details, you have to apply as a new application.",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Go to New Application",
                cancelButtonText: "Cancel",
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = "{{ route('apply-form-a') }}";
                }
            });
        });
        // -----------------------------------------
