            ...
            <div class="tabs" id="tabbedForm">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input autocomplete="off" class="form-control text-box single-line" id="applicant_name" name="applicant_name" type="text" placeholder="Name in which Electrical Contractor's licence is applied for " value="">
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-12">
                                    <textarea id="business_address" rows="2" class="form-control" name="business_address" placeholder="Business Address"></textarea>
                    ...
                    <div class=" border box-shadow-blue p-3 mt-3">
                        <h5 class="Title_formA">3. Proprietor or Partners or Directors Details</h5>
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <input type="number" class="form-control" id="age" name="age[]" maxlength="2" min="15" placeholder="Age" value="">
                            ...
                            <div class="col-md-6">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-12 mt-1  competency-fields" style="display: none;">
                                        <input type="text" class="form-control mt-2" name="competency_certificate_number[]" placeholder="Certificate Number" id="competency_number">
                                    </div>
                                    <div class="col-12 col-md-12 mt-1 competency-fields" style="display: none;">
                                        <input type="text"
                                            class="form-control"
                                            id="competency_certificate_validity"
                                    ...
                                    <div class="col-12 mt-1">
                                        <div id="competency_verify_result" class="text-danger "></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="authorised_no" name="authorised_name_designation" value="no" onclick="toggleAuthorisedFields(false)">
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-12  previous-license-fields" style="display: none;">
                                    <div class="row">
                ...
                <div class="tab" data-name="Staff & Bank Details">
                    ...
                    <div class="row" style="background: #1449c9;color: #fff;">

                        <div class="col-md-12">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 ">
                                    <label style="color: #fff;">6. Details of Staff appointed on full time basis: <span style="color: red;">*</span></label>
                                ...
                                <table class="table table-bordered" id="staff-table">
                                    ...
                                    <tbody id="staff-container">
                                        ...
                                        @for ($i = 0; $i < $staff_count; $i++)
                                            ...
                                            <td>{{ $i + 1 }}</td>
                                            <td>
                                                <input type="text" name="staff_name[]" class="form-control" value="{{ old('staff_name.' . $i) }}">
                                            ...
                                            <td>
                                                <input type="text" class="form-control cc_number" name="cc_number[]" placeholder="Certificate No" value="{{ old('cc_number.' . $i) }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <textarea class="form-control" name="bank_address" placeholder="Name of the Bank and Address"></textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <input type="number" class="form-control" max="99999" id="bank_amount" name="bank_amount" value="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row align-items-center head_label">
                                        <div class="col-12 col-md-12 ">
                                            <label> Fields 8 To 11 are Attachments </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 ">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-5 ">
                                            <label for="Name">12(i) Aadhaar Number <span style="color: red;">*</span>
                                            </label>
                                            <br>
                                        ...
                                        <div class="col-12 col-md-7">
                                            <input type="text" class="form-control text-box" maxlength="14" name="aadhaar" id="aadhaar">
                                ...
                                <div class="col-12 col-md-6 ">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-5 ">
                                            <label for="Name">(ii) Upload Aadhaar Document
                                            </label>
                                            <br>
                                            <label for="tamil" class="tamil">ஆதார் ஆவணத்தை பதிவேற்றவும்
                                            </label>
                                        </div>
                                        <div class="col-12 col-md-7">
                                            ...
                                            <br>
                                            <span class="error text-danger" id="aadhaar_doc_error"></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-7">
                                            <input type="text" class="form-control text-box " name="pancard" maxlength="10" id="pancard">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-7">
                                            <input type="text" class="form-control text-box " name="gst_number" maxlength="15" id="gst_number">
                                ...
                                <div class="col-12 col-md-6 ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-7">
                                            <input autocomplete="off" class="form-control text-box single-line" id="gst_doc" name="gst_doc" type="file" value="">
                                            <span class="file-limit"> File type: PDF (Max 250 KB) </span>
                                            <br>
...
<footer class="main-footer">
    ...
    <div class="proprietor-block border p-3 mt-3" id="proprietor-${index}">
        <h5>3. Proprietor/Partner Details ${index + 1}</h5>
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <input type="radio" name="competency_certificate_holding[${index}]" value="no" class="competency-toggle" data-index="${index}" checked> <label>No</label>
                </div>
                <div class="competency-fields-${index} competency-fields mt-2" style="display: none;">
                  <input type="text" class="form-control mt-2 competency_number" name="competency_certificate_number[]" placeholder="Certificate Number">
                <input type="date" class="form-control mt-2 competency_validity" name="competency_certificate_validity[]">
                <div class="competency_verify_result text-danger mt-1"></div>
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                ...
                <div class="experience-fields-${index} experience-fields mt-2" style="display: none;">
                    ...
                    <input type="text" class="form-control mt-2 ea_license_number" name="previous_experience_lnumber[]" placeholder="License Number">

                    <input type="text" class="form-control mt-2 ea_license_validity" name="previous_experience_lnumber_validity[]" placeholder="License Number Validity"
                        onfocus="this.type='date'" max="{{ date('Y-m-d') }}">

                    <div class="ea_license_result text-danger mt-1"></div>
    ...
    `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.body.addEventListener("click", function(event) {
                if (event.target.id === "add-more-proprietor") {
                    event.preventDefault();

                    if (!validateFirstProprietor()) {
                        Swal.fire({
                            title: "Error",
                            text: "Fill all required fields in the first proprietor section.",
                            icon: "error",
                    ...
                    if (!validateLastProprietor()) {
                        Swal.fire({
                            title: "Error",
                            text: "Fill all required fields in the current Proprietor/Partner section.",
                            icon: "error",
                            showCloseButton: true,
                            customClass: {
                                popup: 'swal2-popup-sm'
                        ...
                        // 👇 Show the static button again in case of error
                    ...
                    if (proprietorCount >= maxProprietors) {
                        Swal.fire({
                            title: "Limit Reached",
                            text: "You can only add up to 4 proprietors.",
                            icon: "error",
                            showCloseButton: true,
                            customClass: {
                                popup: 'swal2-popup-sm'
                    ...
                    // ✅ HIDE STATIC ADD BUTTON AFTER SUCCESSFUL ADD
                    document.getElementById("static-add-button-wrapper")?.classList.add("d-none");

                    const container = document.getElementById("proprietor-container");
                    const existingButtons = container.querySelectorAll("#add-more-proprietor");
                    existingButtons.forEach(btn => btn.parentNode.remove());
                ...
                if (event.target.classList.contains("remove-proprietor")) {
                    ...
                    if (proprietorCount < maxProprietors && lastBlock) {
        ...
        function validateFirstProprietor() {
            ...
            // Find the first index block (always 0)
            const block = document.getElementById("proprietor-0");

            if (block) {

                const compYes = block.querySelector("input[name='competency_certificate_holding[0]'][value='yes']");
                if (compYes && compYes.checked) {
                    const certNum = block.querySelector("input[name='competency_certificate_number[]']");
                    const certDate = block.querySelector("input[name='competency_certificate_validity[]']");
                    if (certNum && certNum.value.trim() === "") {
                        certNum.classList.add("is-invalid");
                        isValid = false;
                    } else if (certNum) {
                        certNum.classList.remove("is-invalid");
                    }
                    if (certDate && certDate.value.trim() === "") {
                        certDate.classList.add("is-invalid");
                        isValid = false;
                    } else if (certDate) {
                        certDate.classList.remove("is-invalid");
                    }
                }


                const empYes = block.querySelector("input[name='presently_employed[0]'][value='yes']");
                if (empYes && empYes.checked) {
                    const empName = block.querySelector("input[name='presently_employed_name[]']");
                    const empAddr = block.querySelector("textarea[name='presently_employed_address[]']");
                    ...
                    if (empAddr && empAddr.value.trim() === "") {
                        empAddr.classList.add("is-invalid");
                        isValid = false;
                    } else if (empAddr) {
                        empAddr.classList.remove("is-invalid");
                    }
                }


                const expYes = block.querySelector("input[name='previous_experience[0]'][value='yes']");
                if (expYes && expYes.checked) {
                    const expName = block.querySelector("input[name='previous_experience_name[]']");
                    const expAddr = block.querySelector("textarea[name='previous_experience_address[]']");
                    const expLic = block.querySelector("input[name='previous_experience_lnumber[]']");
                    if (expName && expName.value.trim() === "") {
                        expName.classList.add("is-invalid");
                        isValid = false;
                    } else if (expName) {
                        expName.classList.remove("is-invalid");
                    }
                    if (expAddr && expAddr.value.trim() === "") {
                        expAddr.classList.add("is-invalid");
                        isValid = false;
                    } else if (expAddr) {
                        expAddr.classList.remove("is-invalid");
                    }
                    if (expLic && expLic.value.trim() === "") {
                        expLic.classList.add("is-invalid");
                        isValid = false;
                    } else if (expLic) {
                        expLic.classList.remove("is-invalid");
                    }
                }
            }
        ...
        function validateLastProprietor() {
            ...
            const index = lastBlock.id.split("-")[1];
            ...
            // Validate conditional fields (Competency Certificate)
            const compYes = lastBlock.querySelector(`input[name='competency_certificate_holding[${index}]'][value='yes']`);
            if (compYes && compYes.checked) {
                const certNum = lastBlock.querySelector("input[name='competency_certificate_number[]']");
                const certDate = lastBlock.querySelector("input[name='competency_certificate_validity[]']");
                if (certNum && certNum.value.trim() === "") {
                    certNum.classList.add("is-invalid");
                    isValid = false;
                } else {
            ...
            // Validate conditional fields (Employment)
            const empYes = lastBlock.querySelector(`input[name='presently_employed[${index}]'][value='yes']`);
            if (empYes && empYes.checked) {
                const empName = lastBlock.querySelector("input[name='presently_employed_name[]']");
                const empAddr = lastBlock.querySelector("textarea[name='presently_employed_address[]']");
                if (empName && empName.value.trim() === "") {
                    empName.classList.add("is-invalid");
                    isValid = false;
                } else {
            ...
            // Validate conditional fields (Experience)
            const expYes = lastBlock.querySelector(`input[name='previous_experience[${index}]'][value='yes']`);
            if (expYes && expYes.checked) {
                const expName = lastBlock.querySelector("input[name='previous_experience_name[]']");
                const expAddr = lastBlock.querySelector("textarea[name='previous_experience_address[]']");
                const expLic = lastBlock.querySelector("input[name='previous_experience_lnumber[]']");
                if (expName && expName.value.trim() === "") {
                    expName.classList.add("is-invalid");
                    isValid = false;
                } else {
