    ...
    <div class="container">
        ...
        <form id="competency_form_a" enctype="multipart/form-data">
            ...
            <div class="tabs" id="tabbedForm">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 col-md-3 offset-md-2 text-md-right">
                            <label>Ownership Type <span class="text-red">*</span></label>
                        </div>
                        <div class="col-12 col-md-5">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="chk-proprietor" value="1">
                                <label class="form-check-label" for="chk-proprietor">Proprietor</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="chk-partners" value="2">
                                <label class="form-check-label" for="chk-partners">Partners</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="chk-directors" value="3">
                                <label class="form-check-label" for="chk-directors">Directors</label>
                            </div>
                        </div>
                    </div>

                    <!-- Directors -->
                    <div id="director-section" style="display:none;" class="mt-3">

                        <div class="row mt-2">
                            <div class="col-12 col-md-5  text-md-right">
                                <h5>Number of Directors? (Min 2, Max 6)</h5>
                            </div>
                            <div class="col-12 col-md-3">
                                <input type="number" class="form-control" id="director-count-input" min="2" max="10" />
                                <span class="error text-danger" id="director-count-error"></span>
                            </div>
                        </div>
                    ...
                    <!-- Partners -->
                    <div id="partner-section" style="display:none;" class="mt-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mt-2 experience-fields-{{ $index }}" style="{{ $showpreviousexpdetails ? '' : 'display: none;' }}">
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-12 col-md-4 mt-1">
                                            <label>Previous EA Licence A Grade License Validity <span class="text-red">*</span></label>
                ...
                <div id="partner-template" style="display:none;">

                    <div class="border box-shadow-blue card p-3 mt-2">

                        <h5>Partner Details</h5>
                        <div class="p-3 mt-3" id="proprietor-section">
                            <div class="row mt-3 ">
                ...
                <div id="director-template" style="display:none;">
                    <div class="border box-shadow-blue card p-3 mt-2">
                ...
                <div id="director-section" style="display:none;">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div id="authority-names-wrapper">
                                            <div class="row authority-name-row">
                                                <div class="col-12 col-md-2 authority-name-group">
                                                ...
                                                <div class="col-12 col-md-2 authority-name-group">
                                                    <input type="number" min="15" max="70" class="form-control authority-name" name="age_of_authorised_to_sign[]" placeholder="Age of Authority">
                                                </div>
                                                <!-- ---------------------- -->
                                                <div class="col-12 col-md-2 authority-name-group">
                                                    <input type="text" class="form-control authority-name" name="qualification_of_authorised_to_sign[]" placeholder="Qualification of Authority"
                                                        oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                                                </div>
                                                <!-- --------------------- -->
                                                <div class="col-12 col-md-5">
            ...
            <div class="tab" data-name="Equipment / Instruments List">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row align-items-center head_label">
                            <div class="col-12 col-md-12 title_bar">
                                <label>[ 13 to 15 ] Equipment / Instruments List: <span style="color: red;">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-1 col-2 text-left">
                                <label for="Name">13.</label>
                            </div>


                            <div class="col-md-6 col-10">
                                <p>(i) One 500 volt meter <span class="text-danger">*</span></p>
                                <p>(ii) One earth tester meter <span class="text-danger">*</span></p>
                                <p>(iii) Single type meter <span class="text-danger">*</span></p>
                                <p>(iv) One live light meter <span class="text-danger">*</span></p>
                            </div>
                            ...
                            <div class="col-md-5 col-12 d-flex align-items-center">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="chk-proprietor">
                                        Manually operated / கையால் இயக்கத்தக்கது
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-7">
                                <label for="tested_documents">
                                    14. The test report of the newly tested instrument must be sent before the application date
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tested_documents" id="tested_documents_yes" value="yes">
                                    <label class="form-check-label" for="tested_documents_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tested_documents" id="tested_documents_no" value="no" checked>
                            ...
                            <div class="col-12 col-md-3" id="tested_report_row" style="display:none;">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <label for="tested_documents">
                                            Tested Report ID
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input type="text" class="form-control" id="tested_report_id" name="tested_report_id" placeholder="Tested Report ID">
                                        <span class="error text-danger" id="tested_report_id_error"></span>
                                    </div>
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="original_invoice_instr" id="original_invoice_instr_yes" value="yes">
                                    <label class="form-check-label" for="original_invoice_instr_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="original_invoice_instr" id="original_invoice_instr_no" value="no" checked>
                                    <label class="form-check-label" for="original_invoice_instr_no">No</label>
                                </div>
                                <span class="error text-danger" id="original_invoice_instr_error"></span>
                            </div>

                            <!-- Input box for Invoice ID -->
                            <div class="col-12 col-md-3" id="invoice_row" style="display:none;">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <label for="invoice_report_id">Invoice ID <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-8">
                                        <input type="text" class="form-control" id="invoice_report_id" name="invoice_report_id" placeholder="Enter Invoice ID">
                                        <span class="error text-danger" id="invoice_report_id_error"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
let proprietorCount = initialDraftCount || 0;
    ...
    <script>
        ...
        // ----------------------------ownership change------------------------
        $('#chk-proprietor, #chk-partners, #chk-directors').on('change', function() {
            let container = $('#ownership-sections');
            let totalMax = 6;
            let used = 0;

            // Proprietor (always 1 if checked)
            if ($('#chk-proprietor').is(':checked')) {
                $('#proprietor-sectionfresh').show().prependTo(container);
                used = 1;
            } else {
                $('#proprietor-sectionfresh').hide();
            }

            let remaining = totalMax - used;

            // Partners
            if ($('#chk-partners').is(':checked')) {
                $('#partner-count-row').show().prependTo(container);
                $('#partner-section').show().prependTo(container);
                $('#partner-count-input').attr({
                    min: 2,
                    max: remaining
                });
            } else {
                $('#partner-count-row').hide();
                $('#partner-section').hide();
                $('#partner-container').empty();
                $('#partner-count-input').val('');
            }

            // Directors
            if ($('#chk-directors').is(':checked')) {
                let lastSection = container.children('div:visible').last();
                if (lastSection.length > 0) {
                    $('#director-count-row').show().insertAfter(lastSection);
                    $('#director-section').show().insertAfter($('#director-count-row'));
                } else {
                    $('#director-count-row').show().appendTo(container);
                    $('#director-section').show().appendTo(container);
                }
                $('#director-count-input').attr({
                    min: 2,
                    max: remaining
                });
            } else {
                $('#director-count-row').hide();
                $('#director-section').hide();
                $('#director-container').empty();
                $('#director-count-input').val('');
            }
        });

        // Adjust counts to respect max = 6
        function adjustCounts() {
            let proprietor = $('#chk-proprietor').is(':checked') ? 1 : 0;
            let partnerCount = parseInt($('#partner-count-input').val()) || 0;
            let directorCount = parseInt($('#director-count-input').val()) || 0;
            let total = proprietor + partnerCount + directorCount;

            if (total > 6) {
                let excess = total - 6;
                if (directorCount > 0) {
                    let newCount = Math.max(2, directorCount - excess);
                    $('#director-count-input').val(newCount).trigger('input');
                } else if (partnerCount > 0) {
                    let newCount = Math.max(2, partnerCount - excess);
                    $('#partner-count-input').val(newCount).trigger('input');
                }
            }
        }

        // Partner count input
        $('#partner-count-input').on('input', function() {
            var count = parseInt($(this).val());
            var minRequired = 2,
                maxAllowed = parseInt($(this).attr('max')) || 6;

            if (count < minRequired) {
                $('#partner-count-error').text("Minimum required is " + minRequired);
                count = minRequired;
                $(this).val(minRequired);
            } else if (count > maxAllowed) {
                $('#partner-count-error').text("Maximum allowed is " + maxAllowed);
                count = maxAllowed;
                $(this).val(maxAllowed);
            } else {
                $('#partner-count-error').text("");
            }

            $('#partner-container').empty();
            for (var i = 1; i <= count; i++) {
                var partnerClone = $('#partner-template').html();
                $('#partner-container').append(
                    partnerClone.replace("Partner Details", "Partner " + i + " Details")
                );
            }
        ...
        // Director count input
        $('#director-count-input').on('input', function() {
            var count = parseInt($(this).val());
            var minRequired = 2,
                maxAllowed = parseInt($(this).attr('max')) || 6;

            if (count < minRequired) {
                $('#director-count-error').text("Minimum required is " + minRequired);
                count = minRequired;
                $(this).val(minRequired);
            } else if (count > maxAllowed) {
                $('#director-count-error').text("Maximum allowed is " + maxAllowed);
                count = maxAllowed;
                $(this).val(maxAllowed);
            } else {
                $('#director-count-error').text("");
            }

            $('#director-container').empty();
            for (var i = 1; i <= count; i++) {
                var directorClone = $('#director-template').html();
                $('#director-container').append(
                    directorClone.replace("Director Details", "Director " + i + " Details")
                );
            }
    ...
    `;
            ...
            // Remove existing Add button from previous row
