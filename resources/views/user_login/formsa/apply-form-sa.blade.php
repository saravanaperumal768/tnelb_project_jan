...
<section class="">
    <div class="auto-container_a">
        <ul id="breadcrumb">
            ...
            <li><a href="#"><span class=" fa fa-info-circle"> </span> Form SA</a></li>
       ...
       <div class="apply-card-header bg-form" >
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h5 class="card-title_apply text-white text-center text-uppercase"> <span style="font-weight: 600;">Application for Electrical Contractors licence Grade Super 'A' </span></h5>

                     <h6 class="card-title_apply text-white mt-2 form-title text-uppercase">FORM - SA / Licence ESA</h4>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 text-md-right">
                    <a href="{{url('assets/pdf/form_sa_notes.pdf')}}" class="text-white" target="_blank">
                        <span class="text-white font-weight-bold"> &nbsp; Instructions  </span>
                        
                        English <i class="fa fa-file-pdf-o" ></i> (75 KB)</a>
        ...
        <form id="contractor_form_sa" enctype="multipart/form-data">
            ...
            <input type="hidden" class="form-control text-box single-line" id="form_name" name="form_name" value="SA">


            <input type="hidden" class="form-control text-box single-line" id="license_name" name="license_name" value="ESA">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div class="row align-items-center head_label mt-2">
                        <div class="col-12 col-md-12 title_bar">
                            <label>3 & 4) Ownership Type - Proprietor / Partners / Directors Details<span style="color: red;">*</span></label>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-12  experience-fields-proprietor" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-5 mt-1">
                                                    <label>Previous ESA Licence SA Grade License Number <span class="text-red">*</span></label>
                                                ...
                                                <div class="col-12 col-md-5 mt-1">
                                                    <label>Previous ESA Licence SA Grade Validity Date <span class="text-red">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="qualification" name="qualification[]" placeholder="Partner" value="">
                                                <!-- <input type="text"
                                        class="form-control" id="validity" name="validity"
                                        placeholder="Validity"
                                        onfocus="(this.type='date')"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-12  experience-fields-partner" style="display: none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-5 mt-1">
                                                        <label>Previous ESA Licence SA Grade Number <span class="text-red">*</span></label>
                                                        <input class="form-control ea_license_number" type="text" id="previous_experience_lnumber" maxlength="15" name="previous_experience_lnumber[]" placeholder="License Number">
                                                    ...
                                                    <div class="col-12 col-md-5 mt-1">
                                                        <label>Previous ESA Licence SA Grade Validity Date (DD/MM/YYYY) <span class="text-red">*</span></label>
                                                        <input class="form-control ea_validity" type="date" 
                                                            onfocus="(this.type='date')"
                                                            id="previous_experience_lnumber_validity" name="previous_experience_lnumber_validity[]" placeholder="License Number Validity">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-12">
                                    <label for="Name">
                                        5. Name and designation of authorised signatory if any in the case of limited company.
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-12">
                                    <label for="Name">6. Whether any application for
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-2 mt-1">
                                            ...
                                            <div id="licenseVerificationBtnWrapper">
                                                ...
                                                @else
                                                <button type="button" class="btn btn-primary" id="verifyLicenseBtn" onclick="verifysaCertificateprevoius(event, this)">Verify</button>
                                                @endif
                                                <input
                                                    type="hidden"
                ...
                <div class="tab" data-name="Staff & Bank Details">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
                                    <label>7. Details of Staff appointed on full time basis: <span style="color: red;">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12  ">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
                                    <label>8. Bank Solvency Certificate Details <span style="color: red;">*</span> </label>
        ...
        $("#save_proprietor").on("click", function() {
           ...
           if (!name || !address || !age || !qualification || !fathersName || !presentBusiness) {
                Swal.fire({
                    ...
                    text: 'Please fill all required fields for Proprietor before Save.',
                    timer: 2500,
            ...
            // ✅ Validation
                if (!name || !address || !age || !qualification || !fathersName || !presentBusiness) {
                    Swal.fire({
                        ...
                        title: 'Missing Details',
                        width : 450,
                        text: 'Please fill all required fields for Partner before Save.',
                        timer: 2500,
                        showConfirmButton: false
                    });
                    return;
