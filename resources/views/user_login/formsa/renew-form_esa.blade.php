        ...
        <div class="apply-card-header bg-form" >
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h5 class="card-title_apply text-white text-center text-uppercase"> <span style="font-weight: 600;">Renewal Application for Electrical Contractors licence Grade Super 'A' </span></h5>
                    ...
                    <div id="proprietor-section" class="mt-3">
                        <div class="row mt-2">
                            ...
                            <div class="table-responsive">
                                ...
                                <p class=" text-red">Note : Incase change of proprietor new application has to be Submitted</p>
                            </div>
                    ...
                    <div id="partner-section" class="mt-3">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="table-responsive">
                                ...
                                <p class="text-red">Note : Incase change of partners new application has to be Submitted </p>
                            </div>
                            <!-- <div class="col-12 col-md-5  text-md-right">
                                <h5>Number of Partners? (Min 2, Max 6)</h5>
                            </div>
                ...
                <div class="tab " data-name="Equipment / Instruments List">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            ...
                            @php
                            // Convert rows into equip_id => value map
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- Hidden inputs -->
                                        <input type="hidden" name="equipments[{{ $index }}][equip_id]" value="{{ $equip->id }}">
                                        <input type="hidden" name="equipments[{{ $index }}][licence_id]" value="{{ $equip->equip_licence_name }}">
                                ...
                                Type: {{ $equip->equipment_type }}
                                            ...
                                            <td>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="equipments">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="equipments[{{ $index }}][value]"
                                                    ...
                                                    <label class="form-check-label" for="equipments">No</label>
                                                </div>
                                            </td>
                                        </tr>
