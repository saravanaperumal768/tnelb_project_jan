        ...
        <form id="competency_form_a" enctype="multipart/form-data">
            ...
            <div class="tabs" id="tabbedForm">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <!-- Directors -->
                    <div id="directorfill-section" style="display:none;" class="mt-3">
                        <div class="row mt-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered head_label">
                                    <thead>
                                        <tr>
                                            <th>Name </th>
                                            <th>Father/s
                        ...
                        <div class="border box-shadow-blue card p-3 mt-2" id="director-section">
                    ...
                    <div id="partner-section" style="display:none;" class="mt-3">
                        ...
                        <div class="border box-shadow-blue card p-3 mt-2" id="partnersfill-section">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="number" class="form-control" min="15" max="70" id="age" name="age[]" maxlength="2" placeholder="Age" value="">
                                                <span class="error text-danger" id="age_error"></span>
                                            </div>
                                            <div class="col-12 col-md-6">
    ...
    `;
        ...
        $("#save_partner").on("click", function() {
            ...
            if (editIndex !== null) {
                ...
                resetPartnerForm(true); // true = hide after update
            } else {
                // Max 6 rows check
                let rowCount = $("#partner-section table tbody tr").length;
                if (rowCount >= 6) {
            ...
            <tr>
                ...
                <td>CC Number & Validity (if any)</td>
                <td>Employment (if any)</td>
                <td>Experience (if any)</td>
                <td><button type="button" class="btn btn-primary btn-sm update-partner-row"><i class="fa fa-pencil"></i></button></td>
                <td><button type="button" class="btn btn-danger btn-sm remove-partner-row"><i class="fa fa-trash-o"></i></button></td>
            </tr>
        `);

                resetPartnerForm(true); // true = hide after save
                partnerIndex++;
            }
        });
        ...
        function resetPartnerForm(hide = false) {
            ...
            $("#cancel_update").remove(); // remove cancel button if exists
            editIndex = null;

            if (hide) {
                $section.slideUp(); // hide form after save/update
            }
        }
        ...
        $(document).on("click", "#cancel_update", function() {
            resetPartnerForm(true); // reset + hide
        });
        ...
        $("#add-director").on("click", function() {
            let rowCount = $("#directorfill-section table tbody tr").length;
            if (rowCount >= 6) {
                alert("You can only add a maximum of 6 partners.");
                return; // stop here
            }
        ...
        $("#save_director").on("click", function() {
            ...
            if (directoreditIndex !== null) {
                // Update existing row
                let $row = $("#directorfill-section table tbody tr").eq(directoreditIndex);
                $row.find("td").eq(0).text(name);
                $row.find("td").eq(1).text(fathersName);
                $row.find("td").eq(2).text(age);
                $row.find("td").eq(3).text(address);
                ...
                resetDirectorForm(true); // true = hide after update
            } else {
                // Max 6 rows check
                let rowCount = $("#directorfill-section table tbody tr").length;
                if (rowCount >= 6) {
                ...
                // Add new row
                $("#directorfill-section table tbody").append(`
            <tr>
                <td>${name}</td>
                <td>${fathersName}</td>
                <td>${age}</td>
                ...
                <td>Employment (if any)</td>
                <td>Experience (if any)</td>
                <td><button type="button" class="btn btn-primary btn-sm update-director-row"><i class="fa fa-pencil"></i></button></td>
                <td><button type="button" class="btn btn-danger btn-sm remove-director-row"><i class="fa fa-trash-o"></i></button></td>
            </tr>
        `);

                resetDirectorForm(true); // true = hide after save
                partnerIndex++;
            }
        });
        ...
        function resetDirectorForm(hide = false) {
            ...
            $("#cancel_director").remove(); // remove cancel button if exists
