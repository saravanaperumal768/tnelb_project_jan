...
<section class="">
    <div class="auto-container_a">
        <ul id="breadcrumb">
            ...
            <li><a href="#"><span class=" fa fa-info-circle"> </span> Form SB</a></li>
...
<section class="tabs-section apply-card">
    <div class="auto-container_a">
        <div class="apply-card-header" style="background-color: #70c6ef  !important;">
            <div class="row">
                <div class="col-12 col-lg-8">
                    <h5 class="card-title_apply text-black text-left"> <span style="font-weight: 600;">Renewal Application for Electrical Contractor's Licence-Grade `SB' </span></h5>
                ...
                <div class="col-12 col-lg-4 text-md-right">
                    <a href="{{url('assets/pdf/formesb_instruction.pdf')}}" class="text-dark" target="_blank">
        ...
        <form id="contractor_form_sb" enctype="multipart/form-data">

            @csrf
            <input type="hidden" class="form-control text-box single-line" id="login_id_store" name="login_id_store" value="{{ Auth::user()->login_id }}">
            <input type="hidden" class="form-control text-box single-line" id="form_name" name="form_name" value="SB">


            <input type="hidden" class="form-control text-box single-line" id="license_name" name="license_name" value="ESB">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div id="proprietor-section" class="mt-3">
                        <div class="row mt-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered head_label_proprietor">
                                  ...
                                  <p class=" text-danger">Note : Incase change of proprietor new application has to be Submitted</p>
                            </div>
                        ...
                        <div class="border box-shadow-blue p-3 mt-3" id="proprietor-sectionfresh" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h5>Proprietor Details fresh 1</h5>
                                </div>
                            </div>
                            <div class="row mt-3">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-12  experience-fields-proprietor" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-5 mt-1">
                                                    <label>Previous ESB Licence SB Grade License Number <span class="text-red">*</span></label>
                                                ...
                                                <div class="col-12 col-md-5 mt-1">
                                                    <label>Previous ESB Licence SB Grade Validity Date <span class="text-red">*</span></label>
                                                    <input class="form-control ea_validity" type="date" max="{{ date('Y-m-d') }}"
                                                        onfocus="(this.type='date')"
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="number" class="form-control" min="12" max="80" id="age" name="age[]" placeholder="Age" value="">
                                                <span class="error text-danger" id="age_error"></span>
                                            </div>
                                            <div class="col-12 col-md-6">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-5 mt-1 competency-fields_partners" style="display: none;">
                                                ...
                                                <input type="text" max="{{ date('Y-m-d') }}"
                                                    onfocus="(this.type='date')"
                                                    class="form-control competency_validity"
                                                    name="competency_certificate_validity[]"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-12  experience-fields-partner" style="display: none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-5 mt-1">
                                                        <label>Previous ESB Licence SB Grade Number <span class="text-red">*</span></label>
                                                        <input class="form-control ea_license_number" type="text" id="previous_experience_lnumber" maxlength="15" name="previous_experience_lnumber[]" placeholder="License Number">
                                                    ...
                                                    <div class="col-12 col-md-5 mt-1">
                                                        <label>Previous ESB Licence SB Grade Validity Date (DD/MM/YYYY) <span class="text-red">*</span></label>
                                                        <input class="form-control ea_validity" type="date" max="{{ date('Y-m-d') }}"
                                                            onfocus="(this.type='date')"
                                                            id="previous_experience_lnumber_validity" name="previous_experience_lnumber_validity[]" placeholder="License Number Validity">
                ...
                <div class="tab" data-name="Staff & Bank Details">
                    ...
                    <div class="row">
                        <div class="col-md-12  ">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
                                    <label>8. Bank Guarantee details <span style="color: red;">*</span> </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <input type="number" class="form-control" id="bank_amount" max="99999"
                                                oninput="if(this.value.length > 5) this.value = this.value.slice(0, 5);" name="bank_amount" value="{{ $banksolvency->bank_amount ?? '' }}">
                ...
                <div class="tab" data-name="Equipment / Instruments List">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
                                    <label>[ 14 to 17 ] Equipment / Instruments : The applicant should possess the following instruments:  <span style="color: red;">*</span></label>
                    ...
                    <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-5 col-12 d-flex align-items-center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="chk-proprietor" value="1" name="equip_check" @if(!empty($equipmentlist->equip_check) && $equipmentlist->equip_check == 1) checked @endif>
                                ...
                                <!-- <div class="col-md-12 col-12">
                                    ...
                                    <p class="text-red"> Note : These instruments should be got tested in Government Electrical Standards Laboratory attached to the office  of the Chief Electrical Inspector to Government, Chennai-32 or in the MRT Laboratory of TNEB within 3 months prior to the date of application and test reports sent along with application</p>
                        ...
                        <div class="col-md-12 ">
                            <div class="row align-items-center">
                                <!-- Label -->
                                <div class="col-12 col-md-7">
                                    <label for="tested_documents">
                                        15. The original invoice for the purchase of the equipment must be sent.
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input
                                            ...
                                            type="radio"
                                            name="invoice"
                                            id="tested_documents_yes"
                                            value="yes"
                                            {{ isset($equipmentlist->invoice) && $equipmentlist->invoice === 'yes' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="tested_documents_yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input
                                            class="form-check-input"
                                            type="radio"
                                            name="invoice"
                                            id="tested_documents_no"
                                            value="no"
                                            {{ !isset($equipmentlist->invoice) || $equipmentlist->invoice === 'no' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="tested_documents_no">No</label>
                                    </div>
                                    <span class="error text-danger" id="tested_documents_error"></span>
                                </div>

                                <!-- Tested Report Row id="tested_report_row" -->
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            ...
                                            id="test_report_yes"
                                            value="yes"
                                            {{ isset($equipmentlist->lab_auth) && $equipmentlist->lab_auth === 'yes' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="test_report_yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            type="radio"
                                            ...
                                            id="test_report_no"
                                            value="no"
                                            {{ !isset($equipmentlist->lab_auth) || $equipmentlist->lab_auth === 'no' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="test_report_no">No</label>
                                    </div>
                                    <span class="error text-danger" id="test_report_error"></span>
                                </div>
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            ...
                                            id="instrument3_yes"
                                            value="yes"
                                            {{ isset($equipmentlist->instrument3_yes) && $equipmentlist->instrument3_yes === 'yes' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="instrument3_yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input"
                                            type="radio"
                                            ...
                                            id="instrument3_no"
                                            value="no"
                                            {{ !isset($equipmentlist->instrument3_yes) || $equipmentlist->instrument3_yes === 'no' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="instrument3_no">No</label>
                                    </div>
                                    <span class="error text-danger" id="instrument3_error"></span>
                                </div>

                                <!-- Instrument 3 Row -->
                                <div class="col-12 col-md-12"
                                    id="instrument3_row"
                                    style="{{ isset($equipmentlist->instrument3_yes) && $equipmentlist->instrument3_yes === 'yes' ? '' : 'display:none;' }}">
                                    <div class="row mt-2">
                                        <div class="col-12 offset-md-2 col-md-3 text-md-right">
                                            <label for="instrument3_id">Branch Office Details <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <textarea class="form-control"  name="instrument3_id" rows='3'>{{ $equipmentlist->instrument3_id ?? '' }}
                                            </textarea>
                                           
                                            <span class="error text-danger" id="instrument3_id_error"></span>
                                        </div>

                                        <!-- <div class="col-12 col-md-1">
                                            <label for="validity_date_eq3">Validity Date <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-12 col-md-2">
                                            <input type="date"
                                                class="form-control"
                                                id="validity_date_eq3"
                                                name="validity_date_eq3"
                                                value="{{ isset($equipmentlist->validity_date_eq3) ? \Carbon\Carbon::parse($equipmentlist->validity_date_eq3)->format('Y-m-d') : '' }}">
                                            <span class="error text-danger" id="validity_date_eq3_error"></span>
                                        </div> -->
                                    </div>
                                </div>
                            </div>
...
let proprietorCount = initialDraftCount || 0;
        ...
        <tr class="staff-fields">
            ...
            <td>
                <input type="text" class="form-control cc_validity" name="cc_validity[]" placeholder="Validity" 
                    onfocus="this.type='date'" max="{{ date('Y-m-d') }}">
                <span class="error text-danger"></span>
            </td>
           <td>
                <button type="button" class="btn btn-primary" onclick="validatestaffcertificate(event, this)">Verify</button>
    ...
    `;
        ...
        // let partnerIndex = 0;
        let directorIndex = 0;
        let directoreditIndex = null; // track row being edited

        // Show form when clicking Add Partner
        ...
        $(document).on("click", "#cancel_director", function() {
            resetDirectorForm(true); // reset + hide
        });
