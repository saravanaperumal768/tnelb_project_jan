                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div class="row align-items-center head_label mt-2">
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-lg-2 ">
                            <select class="custom-select" id="ownership_type_select" disabled>
                                <option value="0">Select Ownership Type</option>
                                <option value="pt"  {{ isset($application) && $application->application_ownershiptype == 'pr' ? 'selected' : '' }}>Proprietorship</option>
                                <option value="pnt" {{ isset($application) && $application->application_ownershiptype == 'pt' ? 'selected' : '' }}>Partnership</option>
                                <option value="pvt" {{ isset($application) && $application->application_ownershiptype == 'pvt' ? 'selected' : '' }}>Private Limited (Pvt LTD)</option>

                                <option value="pvt" {{ isset($application) && $application->application_ownershiptype == 'ltd' ? 'selected' : '' }}>Limited (LTD)</option>
                            </select>


                        <input type="hidden" name="application_ownershiptype" value="{{ $application->application_ownershiptype }}">
