            ...
            <div class="row layout-top-spacing dashboard">
                <nav class="breadcrumb-style-five breadcrumbs_top  mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Portal Footer Useful Links Management Console</li>
                    </ol>
                </nav>
                        ...
                        <div class="widget-header">
                            <div class="row mt-2">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 class="text-dark card-title">Portal Footer Useful Links Management Console </h4>
                                </div>
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header" id="inputFormModalLabel">
                                                            <h5 class="modal-title">Edit Footer Useful Links</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="editusefullinks" enctype="multipart/form-data">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade inputForm-modal reset-on-open" id="inputFormModaladdusefullinks" tabindex="-1" role="dialog" aria-labelledby="inputFormModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">

                                                        <div class="modal-header" id="inputFormModalLabel">
                                                            <h5 class="modal-title">Add New Useful Links Menu</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="mt-0" id="usefullinksnew" enctype="multipart/form-data">
                                                                <!-- Page Type Selection -->
                                                                ...
                                                                <div class="row">
                                                                    @php
                                                                    $nextOrderId = $usefullinks->max('order_id') + 1;
                                                                    @endphp
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Menu Order Number </label>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-info mb-2 me-4 float-end" data-bs-toggle="modal" data-bs-target="#inputFormModaladdusefullinks">
                                                    <i class="fa fa-plus"></i>&nbsp; Add New Useful Links Menu
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="usefulLinksTable" class="table style-3 dt-table-hover portaladmin">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr data-id="{{ $usefullink->id }}">
                                                        <td class="text-center">{{ $loop->iteration }}</td>
                                                        <!-- <td>{{ $usefullink->updated_at->format('d-m-Y') }}</td> -->
                                                        <td>

                                                            {{ $usefullink->menu_name_en }}

                                                        </td>

                                                        <td>
                                                            {{$usefullink->menu_name_ta}}

                                                        </td>



                                                        <td class="text-capitalize">{{ $usefullink->page_type }}</td>


                                                        <td class="external-url">
                                                            @if($usefullink->page_type == 'Static Page')
                                                            {{ $usefullink->menuPage?->page_url ?? '' }}

                                                            @elseif($usefullink->page_type == 'pdf')
                                                            @if($usefullink->menuPage?->pdf_en)
                                                            <a href="{{ asset($usefullink->menuPage->pdf_en) }}" target="_blank" class="me-2" title="English PDF">
                                                            ...
                                                            <a href="{{ $usefullink->menuPage?->external_url ?? '#' }}" target="_blank">External Link</a>

                                                        
                                                            @endif
                                                        </td>

                                                        <td>{{ $usefullink->order_id }}</td>
                                                        <td>
                                                            <span class="badge 
                                                                {{ $usefullink->status == '1' ? 'badge-success' : 
                                                                ($usefullink->status == '0' ? 'badge-dark' : 
                                                                ($usefullink->status == '2' ? 'badge-danger' : '')) }}">
                                                                @if ($usefullink->status == '1')
                                                                Published
                                                                @elseif ($usefullink->status == '0')
                                                                Draft
                                                                @elseif ($usefullink->status == '2')
                                                                Disabled
                                                                @endif
                                                            </span>
                                                        </td>
                                                            ...
                                                            <ul class="table-controls">
                                                                <li>
                                                                    ...
                                                                    <a href="javascript:void(0);" class="editusefullinks"
                                                                        ...
                                                                        data-menu_name_en="{{ $usefullink->menu_name_en }}"
                                                                        data-menu_name_ta="{{ $usefullink->menu_name_ta }}"
                                                                        data-page_url="{{ optional($usefullink->menuPage)->page_url }}"
                                                                        data-page_url_ta="{{ optional($usefullink->menuPage)->page_url_ta }}"
                                                                        data-page_type="{{ $usefullink->page_type }}"
                                                                        data-order_id="{{ $usefullink->order_id }}"
                                                                        data-status="{{ $usefullink->status }}"
                                                                        data-pdf_en="{{ $usefullink->menuPage?->pdf_en ? asset($usefullink->menuPage->pdf_en) : '' }}"
                                                                        data-pdf_ta="{{ $usefullink->menuPage?->pdf_ta ? asset($usefullink->menuPage->pdf_ta) : '' }}"
                                                                        data-external_url="{{ optional($usefullink->menuPage)->external_url }}"
                                                                ...
                                                                @if ($usefullink->page_type == 'Static Page')
                                                                <li>
                                                                    <a href="{{ route('admin.usefullinkscontent', ['id' => $usefullink->id]) }}" title="Edit">
                            ...
                            <div class="lateralDropDownContainer">
                                ...
                                <div class="dropDownItem">
                                    <button class="accordionMenu menu-btn"
                                        data-menu-name="{{ $usefullink->menu_name }}"
                                        data-menu-id="{{ $usefullink->id }}">
                                        <span class="material-icons">rule</span>
                                        <h4>{{ $usefullink->menu_name }}</h4>
                                    </button>
