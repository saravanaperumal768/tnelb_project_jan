            ...
            <div class="row layout-top-spacing dashboard">
                <nav class="breadcrumb-style-five breadcrumbs_top  mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page"><a href="{{route('admin.usefullinks')}}"> Portal Main Menu Management Console </a> </li>
                        <li class="breadcrumb-item active" aria-current="page">Portal Useful Links Content Management Console</li>
                    </ol>
                </nav>
                        ...
                        <div class="widget-header">
                            <div class="row mt-2">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 class="text-dark card-title">Portal Useful Links Content Management Console </h4>
                                </div>
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane fade show active" id="english-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="usefullinkscontent_en">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label> Useful Links Content For {{$usefullink->menu_name_en }} [English]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent" name="menucontent" rows="10">
                                                                    {{$usefullink->menupage?->menucontent ?? '' }}</textarea>
                                                        ...
                                                        <input type="hidden" name="id" value="{{$usefullink->id }}">
                                    ...
                                    <div class="tab-pane fade" id="tamil-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="usefullinkscontent_ta">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label> Useful Links Content For {{$usefullink->menu_name_ta }} [Tamil]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent_ta" name="menucontent_ta" rows="10">
                                                                    {{$usefullink->menupage?->menucontent_ta ?? '' }}</textarea>
