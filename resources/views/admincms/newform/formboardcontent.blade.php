            ...
            <div class="row layout-top-spacing dashboard">
                <nav class="breadcrumb-style-five breadcrumbs_top  mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{route('admin.addnewform')}}" >Form/License Management Console</a> </li>
                                ...
                                <div class="task-container-header">
                                    ...
                                    <div>
                                        <button style="display: none;" type="button" class="btn btn-info float-right mb-2 me-4 _effect--ripple waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#languageSelectModal">
                                            <i class="fa fa-plus"></i>&nbsp; Add/Edit Instructions For {{ $forms->form_name }}/  {{ $forms->license_name }}
                                        </button>
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane fade show active" id="english-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="forminstructions">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>  Instructions For {{ $forms->form_name }}/  {{ $forms->license_name }}</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="instructions" name="instructions" rows="10">
                                                                    {{ $forms->instructions ?? '' }}
                                                                    </textarea>
                                    ...
                                    <!-- <div class="tab-pane fade" id="tamil-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="newsboardcontent_ta">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Notice Board Content For {{ $forms->subject_ta }} [Tamil]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="newsboardcontent_ta" name="newsboardcontent_ta" rows="10">
                                                                    {{ $forms->newsboardcontent_ta ?? '' }}
                                                                    </textarea>
