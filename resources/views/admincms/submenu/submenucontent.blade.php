                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Sub Menu Content For {{ $menu->menu_name_en }} [English]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent" name="menucontent" rows="10">
                                                                    {{ $menu->submenuPage?->menucontent ?? '' }}
                                                                    </textarea>
                                            ...
                                            <div class="card-body">
                                                <form class="mt-0" id="submenucontentedit_ta">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Sub Menu Content For {{ $menu->menu_name_ta }} [Tamil]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent_ta" name="menucontent_ta" rows="10">
                                                                    {{ $menu->submenuPage?->menucontent_ta ?? '' }}
                                                                    </textarea>
