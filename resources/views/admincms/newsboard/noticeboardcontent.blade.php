                        ...
                        <div class="widget-header">
                            <div class="row mt-2">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 class="text-dark card-title">Portal Notice Board Content Management Console </h4>
                                </div>
                                ...
                                <div class="task-container-header">
                                    ...
                                    <div>
                                        <button style="display: none;" type="button" class="btn btn-info float-right mb-2 me-4 _effect--ripple waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#languageSelectModal">
                                            <i class="fa fa-plus"></i>&nbsp; Add New Content For {{ $board->subject_en }} Menu
                                        </button>
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane fade show active" id="english-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="newsboardcontent_en">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Notice Board Content For {{ $board->subject_en }} [English]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="newsboardcontent_en" name="newsboardcontent_en" rows="10">
                                                                    {{ $board->newsboardcontent_en ?? '' }}
                                                                    </textarea>
