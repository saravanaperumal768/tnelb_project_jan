            ...
            <div class="row layout-top-spacing dashboard">
                <nav class="breadcrumb-style-five breadcrumbs_top  mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Portal Sub Menu Content Management Console</li>
                    </ol>
                </nav>
                        ...
                        <div class="widget-header">
                            <div class="row mt-2">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 class="text-dark card-title">Portal Sub Menu Content Management Console </h4>
                                </div>
                                ...
                                <div class="task-container-header">
                                    ...
                                    <div>
                                        <button style="display: none;" type="button" class="btn btn-info float-right mb-2 me-4 _effect--ripple waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#languageSelectModal">
                                            <i class="fa fa-plus"></i>&nbsp; Add New Content For {{ $submenu->menu_name_en }} Menu
                                        </button>
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane fade show active" id="english-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="submenucontentedit_en">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Sub Menu Content For {{ $submenu->menu_name_en }} [English]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent" name="menucontent" rows="10">
                                                                    {{ $submenu->submenuPage?->menucontent ?? '' }}
                                                                    </textarea>
                                    ...
                                    <div class="tab-pane fade" id="tamil-tab">
                                        <div data-draggable="true" class="card img-task">
                                            <div class="card-body">
                                                <form class="mt-0" id="submenucontentedit_ta">
                                                    <div class="row">

                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Sub Menu Content For {{ $submenu->menu_name_ta }} [Tamil]</label>
                                                                <div class="">

                                                                    <textarea class="form-control rich-editor" id="menucontent_ta" name="menucontent_ta" rows="10">
                                                                    {{ $submenu->submenuPage?->menucontent_ta ?? '' }}
                                                                    </textarea>
